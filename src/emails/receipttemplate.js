      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="detail-row">
            ...
            <span class="detail-value">${transaction.type || 'Transaction'}</span>
          </div>
          <div class="detail-row">
          ...
          <div class="detail-row">
            ...
            <span class="detail-value">${new Date(transaction.created_at || Date.now()).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })} at ${new Date(transaction.created_at || Date.now()).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</span>
          </div>

          <div style="text-align:center;margin-top:16px;">
            <a href="${receiptUrl}" class="view-btn">🧾 View Full Receipt</a>
          </div>
          <div style="text-align:center;font-size:11px;color:rgba(255,255,255,0.2);margin-top:8px;">
